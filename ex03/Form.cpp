...
AForm::AForm(const std::string name, const unsigned int	gradeToSign, const unsigned int gradeToExecute, const std::string type) : _name(name), _gradeToExecute(gradeToExecute), _gradeToSign(gradeToSign), _isSigned(false), _type(type)
{
...
void	AForm::isExecutable(Bureaucrat const &bureaucrat)
{
